...
app.get('/team_stats', function(req, res) {
    ...
    return task.batch([
        ...
        task.any('select count(*) from football_games where visitor_score>home_score;')
    ]);
})
.then(data => {
...
app.get('/player_info/post', function(req, res) {
    ...
    return task.batch([
        ...
        task.any(" select count(*) from football_games where array["+player_choice+"] && players;"),
        task.any("select * from football_players where id='"+player_choice+"';")
    ]);
})
.then(data => {
	res.render('pages/player_info',{
